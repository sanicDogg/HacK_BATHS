      ...
      <div class="container">
        ...
        <div class="col-md-6 col-md-offset-0">
          <div class="animate-box">
            <p><a href="register_organization.php" class="btn btn-primary btn-lg btn-custom">Зарегистрироваться</a></p>
          </div>
        </div>
        <div class="col-md-6 col-md-offset-0">
          <div class="animate-box">
            <p><a href="login_organization.php" class="btn btn-primary btn-lg btn-custom">Войти</a></p>
          </div>
        </div>
        </div>
      </div>
